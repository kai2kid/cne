<?php 
class controller_dentrance extends basicController {  
  public $self = "dentrance";
  public $parent = "entrance";
  public $p_code = "";
  public $prefix = "dentrance";  
  public $pk = "ticket_code";
  public $p_pk = "entrance_code";
