<div class="panel-heading">
  ...
  <h3 class="panel-title">Delete Buyer</h3>
</div>
<div class="panel-body">
  <form class="form-horizontal" action="buyer_deleting" method="post">
    <div class="form-group">
      <label for="buyer_code" class="control-label col-md-6 no-pad-r">Do you really want to delete </label>
      <div class="col-md-3">
