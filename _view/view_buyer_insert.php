  ...
  <form class="form-horizontal" action="buyer_inserting" method="post">
    ...
    <div class="form-group">
	 ...
	 <div class="form-group">
      ...
      <div class="col-md-5">
        <input name="buyer_website" type="text" class="form-control" id="buyer_website" placeholder="ID Number">
      </div>
    </div>           
    <div class="form-group">
	...
	<div class="form-group">
      ...
      <div class="col-md-8">
        <input name="buyer_memo" type="text" class="form-control" id="buyer_memo" placeholder="Memo">
        </select>
      </div>            
    </div>
    <div class="form-group">
