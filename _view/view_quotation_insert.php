...
<!-- INI START FORM -->  
    ...
    <form class="form-horizontal" id="formInsertHeader" action="quotation_insertHeader" method="post" onsubmit="quotationSubmitForm(this.id);return false;">
      <div class="form-group">
        ...
        <div class="col-md-4">
        <input name="quotation_name" type="text" class="form-control" id="quotation_name" placeholder="Name" value="">
        </div>
      </div>
      <div class="form-group">
              ...
              <!------------JENIS 2--------------->
                <div class="cont-hotel2">
                  ...
                  <div class="form-group hotel_type2 input-hotel2_<?php echo $day;?>">
                    ...
                    <div class="col-md-4 no-pad-r" style="margin-right: 5px;">
                    <?php echo $hotel->_combobox('hotel_cb_2_'.$day); ?>
                    </div>
                    <div class="col-md-1 no-pad-l no-pad-r" style="margin-right:5px;">
                    <input name="hotel_ed_2_<?php echo $day; ?>" type="number" class="form-control" id="hotel_ed_2_<?php echo $day; ?>" placeholder="Night" onchange="changeHotel(2,<?php echo $day;?>)" value="1">
                    </div>
              ...
              <!------------JENIS 3--------------->
                <div class="cont-hotel3">
                  ...
                  <div class="form-group hotel_type3 input-hotel3_<?php echo $day;?>">
                    ...
                    <div class="col-md-4 no-pad-r" style="margin-right: 5px;">
                    <?php echo $hotel->_combobox('hotel_cb_3_'.$day); ?>
                    </div>
                    <div class="col-md-1 no-pad-l no-pad-r" style="margin-right:5px;">
                    <input name="hotel_ed_3_<?php echo $day; ?>" type="number" class="form-control" name="hotel_ed_3_<?php echo $day; ?>" placeholder="Night" onchange="changeHotel(3,<?php echo $day;?>)" value="">
                    </div>
          ...
          <div class="panel-body quotation-body">
            ...
            <?php for ($day=1; $day <= 1; $day++) { ?>
              <div class="form-group input-entrance">
                ...
                <div class="col-md-8">
                <?php echo $entrance->_combobox('entrance_'.$day); ?>
              </div>
            </div>
            <?php } ?>
            ...
            <form name="formInsertMeal" id="formInsertMeal" class="form-horizontal" action="quotation_insertMeal" method="post" onsubmit="quotationSubmitForm(this.id);return false;">
              ...
              <table class='table borderless table-font' cellspacing='0' width='100%' id="table-meal">
                ...
                <tr class="list-of-meal">
                  ...
                  <td><?php echo $restaurant->_comboboxMeal('restaurant_'.$day."_1"); ?></td>
                  <td><?php echo $restaurant->_comboboxMeal('restaurant_'.$day."_2"); ?></td>
                  <td><?php echo $restaurant->_comboboxMeal('restaurant_'.$day."_3"); ?></td>
                </tr>                    
                <?php } ?>
                </tbody>
              </table>
          ...
          <div class="panel-body quotation-body">
            <form name="formInsertRundown" id="formInsertRundown" class="form-horizontal" action="quotation_insertRundown" method="post" onsubmit="quotationSubmitForm(this.id);return false;">
              <?php for ($day=1; $day <= 1 ; $day++) { ?>
                  ...
                  <div class='form-group'>
                  <label id="runday_<?php echo $day; ?>" class='control-label col-md-5 no-pad-l' style='text-align: left; margin-left: 5px;'>D<?php echo $day. ": -"; ?></label>
                  </div>
                  <?php $i=0; ?>
                  <?php $i++; ?>
                  ...
                  <div class='form-group'>
                    ...
                    <input name='qtimeStart_<?php echo $day;?>1' type='time' class='form-control' id='qtimeStart_<?php echo $day;?>1' value="">
                    </div>
                    <label class='control-label col-md-1 no-pad-l no-pad-r' style='margin-right:5px; width: 10px;'>-</label>
                    <div class='col-md-1 no-pad-l no-pad-r' style='margin-right: 5px;'>
                    <input name='qtimeEnd_<?php echo $day;?>1' type='time' class='form-control' id='qtimeEnd_<?php echo $day;?>1'  value="">
                    </div>
                    <div class='col-md-4 no-pad-l'>
                    <input name='qremark_<?php echo $day;?>1' type='text' class='form-control' id='qremark_<?php echo $day;?>1' value="">
                    </div>
