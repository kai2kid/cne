  ...
  <form class="form-horizontal" action="restaurant_inserting" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4 no-pad-l">
        <input name="restaurant_city" type="text" class="form-control" id="restaurant_city" placeholder="City">
      </div> 	  
    </div>   
	<div class="form-group">
      <label for="restaurant_location" class="control-label col-md-3 no-pad-r">Location</label>
      <div class="col-md-3">
        <input name="restaurant_location" type="text" class="form-control" id="restaurant_location" placeholder="Location">        
      </div>            
    </div>	
	<div class="form-group">
