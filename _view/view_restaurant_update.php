      ...
      <div class="panel-body">
        <form class="form-horizontal" action="restaurant_updating" method="post">
          ...
          <div class="form-group">
            <label for="restaurant_name_korean" class="control-label col-md-3 no-pad-r">Korean Name</label>
            <div class="col-md-5">
              <input name="restaurant_name_korean" type="text" class="form-control" id="restaurant_name_korean" placeholder="&#51060;&#47492;" value="<?php echo $data['restaurant_name_korean']; ?>">
            </div>
          </div>    
          <div class="form-group">
