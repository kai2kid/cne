      ...
      <div class="panel-body">
        <form class="form-horizontal" action="staff_updating" method="post" enctype="multipart/form-data">
          <div class="row">
			<div class="col-md-8" style="margin-left: 13px;">
				<div class="form-group">
					<label for="staff_code" class="control-label col-md-4 no-pad-r">Code</label>
					<div class="col-md-6">
			...
			<div class="col-md-3">
				<img class="img-photo" src="<?php echo _PATH_IMAGE?>/staff/<?php echo $data['staff_code'].".png?".rand(0,999); ?>" height="150px" >
